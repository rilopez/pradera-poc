...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.pradera.poc.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.pradera.poc.repository.UserRepository.USERS_BY_EMAIL_CACHE);
