  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="praderaApp.book.home.createOrEditLabel" data-cy="BookCreateUpdateHeading">
            <Translate contentKey="praderaApp.book.home.createOrEditLabel">Create or edit a Book</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : bookEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="titleLabel" for="book-title">
                  <Translate contentKey="praderaApp.book.title">Title</Translate>
                </Label>
                <AvField
                  id="book-title"
                  data-cy="title"
